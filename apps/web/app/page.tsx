...
export default function Home() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <p className="mb-12 text-gray-600 text-lg dark:text-gray-400">
        Playwrightを使ったビジュアルリグレッションテスト（VRT）とE2Eテストのサンプルプロジェクトです。
      </p>

      {/* Button コンポーネントのデモ: バリアント（Primary/Secondary/Danger）とサイズ（S/M/L） */}
      <section className="mb-12">
        <h2 className="mb-4 font-semibold text-2xl dark:text-gray-100">
          Button
        </h2>
      ...
      <section className="mb-12">
        <h2 className="mb-4 font-semibold text-2xl dark:text-gray-100">Card</h2>
